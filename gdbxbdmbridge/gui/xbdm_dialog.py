...
class XBDMDialog(wx.Dialog):
    ...
    def _on_connected(self, evt):
        ...
        # cmd = rdcp_command.MagicBoot(
        #     "e:\\Tools\\boxplorer\\default.xbe", True, True, handler=print
        # )
        # self._bridge.send_rdcp_command(cmd)
        ...
        cmd = rdcp_command.Notify(handler=print)
        self._bridge.send_rdcp_command(cmd)

        cmd = rdcp_command.NotifyAt(handler=print)
        self._bridge.send_rdcp_command(cmd)
